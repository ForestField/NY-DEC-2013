...
public class piece_2_rectangle extends PApplet {
...
//
freq2=27.5f+27.5f*3/2+27.5f*3/2;
freq=freq2;
square1.setFreq(freq);
square2.setFreq(6*freq/5); //minor 3rd
square3.setFreq((6*freq/5)+(5*freq/4)); //major 3rd
...
//
freq3=27.5f+27.5f*3/2+27.5f*3/2+27.5f/3*2;
freq=freq3;
square1.setFreq(freq);
square2.setFreq(6*freq/5); //minor 3rd
square3.setFreq((6*freq/5)+(5*freq/4)); //major 3rd
...
//
freq4=27.5f+27.5f*3/2+27.5f*3/2+27.5f*3/2+27.5f/3*2;
freq=freq4;
square1.setFreq(freq);
square2.setFreq(6*freq/5); //minor 3rd
square3.setFreq((6*freq/5)+(5*freq/4)); //major 3rd
...
//  noFill();
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--hide-stop", "piece_2_rectangle" });
  }
}
