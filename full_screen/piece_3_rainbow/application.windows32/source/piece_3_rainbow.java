...
public class piece_3_rainbow extends PApplet {
...
//**MAIN HEADER-------------AUDIO------------**\\
  ...
  sineG = new SineWave(145.00f, off, out.sampleRate());//1st sine wave - frequency between G and an A
  ...
  squareB = new SquareWave(880, .5f, out.sampleRate()); 
...
if(average<=36){
 ...
 int calibration=100; 
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--hide-stop", "piece_3_rainbow" });
  }
}
